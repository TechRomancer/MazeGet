...
import mazeget.states.MazeState;
import mazeget.states.OverworldState;
import mazeget.states.TitleState;
...
public class MazeMain extends StateBasedGame {
	...
	public void initStatesList(GameContainer container) throws SlickException {
		...
		addState(new OverworldState(OVERWORLD_STATE, container));
